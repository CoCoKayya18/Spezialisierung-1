...
kinematic_train, kinematic_temp = train_test_split(kinematic_delta_values, test_size=0.3, random_state=42)
X_val, X_test, Y_val, Y_test = train_test_split(X_temp, Y_temp, test_size=0.5, random_state=42)
kinematic_val, kinematic_test = train_test_split(kinematic_temp, test_size=0.5, random_state=42)
...
df_Kinematic_Train = pandas.DataFrame(kinematic_train, columns=kinematic_deltas)
df_Kinematic_Val = pandas.DataFrame(kinematic_val, columns=kinematic_deltas)
df_Kinematic_Test = pandas.DataFrame(kinematic_test, columns=kinematic_deltas)

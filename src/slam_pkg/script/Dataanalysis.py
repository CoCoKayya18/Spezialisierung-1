...
# Load the data
data_path = '/home/cocokayya18/Spezialisierung-1/src/slam_pkg/data/Data_Square_RobotFrameDeltas_Direction.csv'
data_df = pd.read_csv(data_path)

columns_of_interest = ['linear_velocity_x', 'angular_velocity_yaw', 'linear_acceleration_x', 'angular_acceleration_yaw', 'delta_position_x_robot', 'delta_position_y_robot', 'delta_yaw']

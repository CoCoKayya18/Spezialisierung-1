...
# SpecialCase = ''
# dataName = 'Data.csv'
dataName = 'Data_Square_RobotFrameDeltas_Direction.csv'
...
dataframe = pandas.read_csv(os.path.join(datafilepath, f'{isSparse}{ith_datapoint}_DP_test_data{SpecialCase}.csv'))
...
target = ['delta_position_x_robot', 'delta_position_y_robot', 'delta_yaw']
...
filename = f'{isTuned}{isSparse}{ith_datapoint}{SpecialCase}_DP_predictions_vs_real_test.csv'
